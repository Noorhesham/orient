...
const Card = ({ img, text, children, width, className, price, id, sell, desc }: CardProps) => {
  return (
    ...
    >
      <div className="absolute top-1/2 h-fit left-1/2 -translate-x-1/2 -translate-y-1/2  w-full z-30 max-w-[14rem]  group-hover:opacity-100 opacity-0 transition-opacity duration-300">
