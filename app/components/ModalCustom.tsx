...
const ModalCustom = ({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className=" max-w-[90%] lg:max-w-4xl py-8 lg:py-12 overflow-y-auto max-h-[80vh] sm:rounded-[1.8rem]">
        <DialogHeader className="">
          {title ? (
            <DialogTitle className="text-xl lg:text-3xl capitalize mt-10 lg:mt-14 text-center text-main2">{title}</DialogTitle>
          ) : (
            <VisuallyHidden>
