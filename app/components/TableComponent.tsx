    ...
    <Table className="">
      ...
      <TableHeader className=" w-full">
        <TableRow className="  w-full">
          <TableHead className="  py-2   w-fit h-auto flex-grow bg-main2 rounded-full  text-gray-50 font-semibold text-center">
            NAME PRODUCTS
          </TableHead>
          <TableHead className="w-fit h-auto flex-grow bg-main2 rounded-full  text-gray-50 font-semibold text-center">
            Status
          </TableHead>
          <TableHead className=" w-fit h-auto flex-grow bg-main2 rounded-full  text-gray-50 font-semibold text-center">
            DATE
        ...
        {data.map((product: any) => (
          <TableRow key={product.name}>
            <TableCell className="flex  items-center gap-2">
              <div className=" rounded-lg aspect-square w-12 h-12 relative">
                <Image src={product.image} className=" rounded-lg object-cover" alt="product image" fill />
              </div>
              <p className=" max-w-[10rem] text-base font-semibold text-main2">{product.name}</p>
            </TableCell>
            <TableCell className=" text-main2">{product.status}</TableCell>
              ...
              <ModalCustom
                ...
                content={
                  <div className=" px-10">
                    ...
                    <div className=" grid items-center  py-3 gap-8 grid-cols-2">
