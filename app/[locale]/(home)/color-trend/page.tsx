      ...
      <div className=" flex items-center    mt-[128px]">
        ...
        <Section link="#" className="mt-[79px] " heading="BEST SELLERS" linkText="BROWSE ALL PRODUCTS">
          <div className="  grid grid-cols-3 items-center gap-5 mt-[62px] ">
            <Card width="w-44 h-44" text={`putty (acrylic 1000) 233`} img="Image.svg">
              <p className="text-[#CA0096] font-semibold text-sm uppercase">442.12 EGP</p>
            </Card>

            <Card width="w-44 h-44" className=" text-sm" text={`putty (acrylic 1000) 233`} img="Image (5).svg">
              <p className="text-[#CA0096] font-semibold text-sm uppercase">442.12 EGP</p>
            </Card>
            <Card width="w-44 h-44" className=" text-sm" text={`putty (acrylic 1000) 233`} img="Image (6).svg">
              <p className="text-[#CA0096] font-semibold text-sm uppercase">442.12 EGP</p>
            </Card>
          </div>
        </Section>
